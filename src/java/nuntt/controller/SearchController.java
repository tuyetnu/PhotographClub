    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (txtSearch.isEmpty()) {
                errorDTO.setFullnameError("Fullname can't be black!");
                request.setAttribute("errorObj", errorDTO);
            } else {
                RegistrationDAO dao = new RegistrationDAO();
                List<RegistrationDTO> resutl = dao.findByLikeFullname(txtSearch);
                request.setAttribute("INFO", resutl);
            }
        } catch (Exception e) {
